...
""",
    ...
    http_archive(
        ...
        url = "https://ftp.mozilla.org/pub/firefox/releases/123.0b2/linux-x86_64/en-US/firefox-123.0b2.tar.bz2",
        sha256 = "a5ba0fc86630b40ba3d555698174962ddbe1414c1d518843aff4c15279f2b3ab",
        build_file_content = """
filegroup(
    name = "files",
    srcs = glob(["**/*"]),
...
""",
    ...
    dmg_archive(
        ...
        url = "https://ftp.mozilla.org/pub/firefox/releases/123.0b2/mac/en-US/Firefox%20123.0b2.dmg",
        sha256 = "c8198c089534f8eab97e40505b66e01d01fff0b8e404589607b4c5511e7d9945",
        build_file_content = "exports_files([\"Firefox.app\"])",
    )
