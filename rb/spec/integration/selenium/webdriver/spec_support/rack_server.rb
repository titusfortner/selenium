  ...
  module WebDriver
    module SpecSupport
      class RackServer
        ...
        # DIAGNOSTIC (temporary): record every request that reaches the server, so a page the browser
        # never rendered can be told apart from one the server never sent.
        def access_log
